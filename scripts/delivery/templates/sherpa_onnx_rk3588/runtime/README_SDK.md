...
This runtime bundle packages a board-side streaming ASR (RKNN) for RK3588:
...
- run_asr.sh, smoketest.sh: board-side helper entrypoints.
...
TTS is provided by the separate MeloTTS-RKNN2 runtime bundle.
