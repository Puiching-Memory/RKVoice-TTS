...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--include-runtime-bundle", action="store_true", help="Include artifacts/runtime/rkvoice_runtime.tar.gz")
    parser.add_argument("--include-evidence", action="store_true", help="Include artifacts/runtime/rkvoice_runtime/asr/output and artifacts/runtime/rkvoice_runtime/tts/output when present")
